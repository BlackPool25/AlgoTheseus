  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex gap-2">
        <input
          className="flex-1 bg-viz-body rounded px-2 py-1.5 text-xs text-viz-ink font-mono outline-none focus:ring-1 focus:ring-viz-line placeholder:text-viz-ink/60"
